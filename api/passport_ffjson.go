...
func (j *Credentials) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	...
	fflib.WriteJsonString(buf, string(Nonce))
	buf.WriteByte('}')
	return nil
}
...
handle_Data:
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			Data = make(map[string]*SecureValue, 0)
...
func (j *DataCredentials) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	...
	fflib.WriteJsonString(buf, string(DataHash))
	buf.WriteString(`,"secret":`)
	fflib.WriteJsonString(buf, string(Secret))
	buf.WriteByte('}')
	return nil
}
...
func (j *EncryptedCredentials) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	...
	fflib.WriteJsonString(buf, string(Data))
	buf.WriteString(`,"hash":`)
	fflib.WriteJsonString(buf, string(Hash))
	buf.WriteString(`,"secret":`)
	fflib.WriteJsonString(buf, string(Secret))
	buf.WriteByte('}')
	return nil
...
func (j *EncryptedPassportElement) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	...
	fflib.WriteJsonString(buf, string(Type))
	buf.WriteByte(',')
	if len(Data) != 0 {
		buf.WriteString(`"data":`)
		fflib.WriteJsonString(buf, string(Data))
	...
	if len(PhoneNumber) != 0 {
		...
		fflib.WriteJsonString(buf, string(PhoneNumber))
		buf.WriteByte(',')
	}
	if len(Email) != 0 {
		buf.WriteString(`"email":`)
		fflib.WriteJsonString(buf, string(Email))
		buf.WriteByte(',')
	}
	if len(Files) != 0 {
...
handle_PhoneNumber:
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			PhoneNumber = string(string(outBuf))
...
func (j *FileCredentials) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	...
	fflib.WriteJsonString(buf, string(FileHash))
	buf.WriteString(`,"secret":`)
	fflib.WriteJsonString(buf, string(Secret))
	buf.WriteByte('}')
	return nil
...
func (j *IDDocumentData) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	...
	fflib.WriteJsonString(buf, string(DocumentNumber))
	buf.WriteString(`,"expiry_date":`)
	fflib.WriteJsonString(buf, string(ExpiryDate))
	buf.WriteByte('}')
	return nil
}
...
handle_DocumentNumber:
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			DocumentNumber = string(string(outBuf))
...
handle_ExpiryDate:
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			ExpiryDate = string(string(outBuf))
...
func (j *PassportElementErrorDataField) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	...
	fflib.WriteJsonString(buf, string(Source))
	buf.WriteString(`,"type":`)
	fflib.WriteJsonString(buf, string(Type))
	buf.WriteString(`,"field_name":`)
	fflib.WriteJsonString(buf, string(FieldName))
	buf.WriteString(`,"data_hash":`)
	fflib.WriteJsonString(buf, string(DataHash))
	buf.WriteString(`,"message":`)
	fflib.WriteJsonString(buf, string(Message))
	buf.WriteByte('}')
	return nil
}
...
handle_FieldName:
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			FieldName = string(string(outBuf))
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				FileHashes = append(FileHashes, tmpJFileHashes)
...
func (j *PassportFile) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	...
	fflib.WriteJsonString(buf, string(FileID))
	buf.WriteString(`,"file_size":`)
	fflib.FormatBits2(buf, uint64(FileSize), 10, FileSize < 0)
	buf.WriteString(`,"file_date":`)
	fflib.FormatBits2(buf, uint64(FileDate), 10, FileDate < 0)
	buf.WriteByte('}')
	return nil
}
...
func (j *PassportRequestInfoConfig) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	...
	fflib.FormatBits2(buf, uint64(BotID), 10, BotID < 0)
	if Scope != nil {
	...
	fflib.WriteJsonString(buf, string(PublicKey))
	buf.WriteByte('}')
	return nil
}
...
handle_PublicKey:
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			PublicKey = string(string(outBuf))
...
func (j *PersonalDetails) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	...
	fflib.WriteJsonString(buf, string(FirstName))
	buf.WriteString(`,"last_name":`)
	fflib.WriteJsonString(buf, string(LastName))
	buf.WriteString(`,"middle_name":`)
	fflib.WriteJsonString(buf, string(MiddleName))
	buf.WriteString(`,"birth_date":`)
	fflib.WriteJsonString(buf, string(BirthDate))
	buf.WriteString(`,"gender":`)
	fflib.WriteJsonString(buf, string(Gender))
	buf.WriteString(`,"country_code":`)
	fflib.WriteJsonString(buf, string(CountryCode))
	buf.WriteString(`,"residence_country_code":`)
	fflib.WriteJsonString(buf, string(ResidenceCountryCode))
	buf.WriteString(`,"first_name_native":`)
	fflib.WriteJsonString(buf, string(FirstNameNative))
	buf.WriteString(`,"last_name_native":`)
	fflib.WriteJsonString(buf, string(LastNameNative))
	buf.WriteString(`,"middle_name_native":`)
	fflib.WriteJsonString(buf, string(MiddleNameNative))
	buf.WriteByte('}')
	return nil
}
...
handle_FirstName:
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			FirstName = string(string(outBuf))
...
handle_MiddleName:
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			MiddleName = string(string(outBuf))
...
handle_BirthDate:
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			BirthDate = string(string(outBuf))
...
handle_CountryCode:
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			CountryCode = string(string(outBuf))
...
handle_ResidenceCountryCode:
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			ResidenceCountryCode = string(string(outBuf))
...
handle_FirstNameNative:
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			FirstNameNative = string(string(outBuf))
...
handle_LastNameNative:
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			LastNameNative = string(string(outBuf))
...
handle_MiddleNameNative:
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			MiddleNameNative = string(string(outBuf))
...
handle_ReverseSide:
...

	{
		if tok == fflib.FFTok_null {
			...
			if ReverseSide == nil {
				ReverseSide = new(FileCredentials)
			}
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				Translation = append(Translation, tmpJTranslation)
